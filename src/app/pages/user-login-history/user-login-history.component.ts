...
export class UserLoginHistoryComponent {
  ...
  @ViewChild('loggedInDateTemplate', { static: true }) loggedInDateTemplate!: TemplateRef<any>;
  ...
  defineColumn() {
    this.columns = [
      ...
      { field: 'loggedInDate', header: 'Logged In Date', template: this.loggedInDateTemplate },
      { field: 'os', header: 'OS' },
