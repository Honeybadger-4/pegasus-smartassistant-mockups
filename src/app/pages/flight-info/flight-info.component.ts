...
export class FlightInfoComponent {
  ...
  defineLoadSheetColums() {
    this.loadSheetCols = [
      ...
      { field: 'loadSheet', header: 'Load Sheet' },
      { field: 'cgLimits', header: 'CG Limits' },
    ];
  }
  ...
  activeTabIndexChange(value: number) {
    switch (value) {
      case 0:
        this.expandedTableColumns = this.crewCols;
        this.expandedTableData = this.crewData;
        break;
      case 1:
        this.expandedTableColumns = this.flightPlanCols;
        this.expandedTableData = this.flightPlanData;
        break;
      case 2:
        this.expandedTableColumns = this.tripInfoCols;
        this.expandedTableData = this.tripInfoData;
        break;
      case 3:
        this.expandedTableColumns = this.loadSheetCols;
        this.expandedTableData = this.loadSheetData;
        break;
    }
  }
}
