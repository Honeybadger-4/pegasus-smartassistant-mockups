...
export class FlightInfoComponent {
  ...
  defineTripInfoColums() {
    this.tripInfoCols = [
      ...
      { field: 'tripInfo', header: 'Trip Info', template: this.tripInfoTableTripInfoCellTemplate },
    ];
  }
  ...
  defineLoadSheetColums() {
    this.loadSheetCols = [
      ...
      { field: 'loadSheet', header: 'Load Sheet', template: this.loadSheetTableLoadSheetCellTemplate },
      { field: 'cgLimits', header: 'CG Limits', template: this.loadSheetTableCGLimitsCellTemplate },
    ];
  }
